...
isEmpty(TASBASE_PRI) {
    ...
    isEmpty(SETTINGS_PATH) {
        win:SETTINGS_PATH=/qttas/conf
        else:SETTINGS_PATH=/etc/testability
    }
    ...
    win32:TAS_TARGET_HEADERS=$$PREFIX/inc
    else:TAS_TARGET_HEADERS=$$PREFIX/include/tdriver
    win32: TAS_TARGET_STEPS=$$SETTINGS_PATH/../cucumber
    else: TAS_TARGET_STEPS=$$SETTINGS_PATH/cucumber
